...
?>
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li style="<?php if ($d['level'] == 1) {
              ...
              <a href="../transaksi/transaksi.php">
                ...
                <i class="fa fa-exchange"></i> <span>Sirkulasi</span>
  ...
  <div class="row">
    ...
    <div class="col-xs-12">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              while ($dpeng = mysqli_fetch_array($pengunjung)) {
                ...
                $bulan = date("Y-m", strtotime($dpeng['tgl']));
                if (!isset($data_bulan[$bulan])) {
                  $data_bulan[$bulan] = 0;
                }
                $data_bulan[$bulan]++;
              ?>
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Grafik Pengunjung per Bulan</h3>
        </div>
        <div class="box-body">
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    var dataBulan = <?php echo json_encode(array_keys($data_bulan)); ?>;
    var dataJumlah = <?php echo json_encode(array_values($data_bulan)); ?>;
